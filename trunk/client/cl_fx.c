...
void CL_EntityEvent (entity_state_t *ent)
{
	...
	case EV_ITEM_RESPAWN:
		S_StartSound (NULL, ent->number, CHAN_WEAPON, shMedia.sfx.cl_sfx_itemRespawn, 1, ATTN_IDLE, 0);
		CL_ItemRespawnParticles (ent->origin);
		break;
	case EV_PLAYER_TELEPORT:
		S_StartSound (NULL, ent->number, CHAN_WEAPON, shMedia.sfx.cl_sfx_playerTeleport, 1, ATTN_IDLE, 0);
		CL_TeleportParticles (ent->origin);
		break;
	case EV_FOOTSTEP:
		if (cl_footsteps->value)
			S_StartSound (NULL, ent->number, CHAN_BODY, shMedia.sfx.cl_sfx_footsteps[rand () & 3], 1, ATTN_NORM, 0);
		break;
	case EV_FALLSHORT:
		S_StartSound (NULL, ent->number, CHAN_AUTO, shMedia.sfx.cl_sfx_playerFallShort, 1, ATTN_NORM, 0);
		break;
	case EV_FALL:
		S_StartSound (NULL, ent->number, CHAN_AUTO, shMedia.sfx.cl_sfx_playerFall, 1, ATTN_NORM, 0);
		break;
	case EV_FALLFAR:
		S_StartSound (NULL, ent->number, CHAN_AUTO, shMedia.sfx.cl_sfx_playerFallFar, 1, ATTN_NORM, 0);
		break;
	}
}
