...
#define ART_BANNER				"ui/banners/network_t"
#define ART_TEXT1				"ui/text/network_text_p1"
#define ART_TEXT2				"ui/text/network_text_p2"
...
static void UI_Network_SetConfig (void){
	...
	if (uiNetworkInitial.rate != uiNetwork.rate.curValue){
		...
		case 0:
			Cvar_SetInteger("rate", 2500);
			break;
		case 1:
			Cvar_SetInteger("rate", 3000);
			break;
		case 2:
			Cvar_SetInteger("rate", 4000);
			break;
		case 3:
			Cvar_SetInteger("rate", 5000);
			break;
		case 4:
			Cvar_SetInteger("rate", 25000);
			break;
		}
	}
...
static void UI_Network_Init (void){
	...
	memset(&uiNetwork, 0, sizeof(uiNetwork_t));
