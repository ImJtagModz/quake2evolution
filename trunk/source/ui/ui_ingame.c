...
#define ART_LOGO				"ui/ingui/main"
#define ART_BLUR				"ui/ingui/edge_blur"
#define ART_LOADGAME			"ui/ingui/titles/load_game_n"
#define ART_LOADGAME2			"ui/ingui/titles/load_game_s"
#define ART_SAVEGAME			"ui/ingui/titles/save_game_n"
#define ART_SAVEGAME2			"ui/ingui/titles/save_game_s"
#define ART_OPTIONS				"ui/ingui/titles/options_n"
#define ART_OPTIONS2			"ui/ingui/titles/options_s"
#define ART_RESUMEGAME			"ui/ingui/titles/return_to_game_n"
#define ART_RESUMEGAME2			"ui/ingui/titles/return_to_game_s"
#define ART_LEAVEGAME			"ui/ingui/titles/return_to_menu_n"
#define ART_LEAVEGAME2			"ui/ingui/titles/return_to_menu_s"
#define ART_EXITGAME			"ui/ingui/titles/exit_game_n"
#define ART_EXITGAME2			"ui/ingui/titles/exit_game_s"
...
static void UI_InGame_Init (void){
	...
	memset(&uiInGame, 0, sizeof(uiInGame_t));
...
void UI_InGame_Precache (void){
	...
	R_RegisterShaderNoMip(ART_BLUR);
	R_RegisterShaderNoMip(ART_LOADGAME);
	R_RegisterShaderNoMip(ART_LOADGAME2);
	R_RegisterShaderNoMip(ART_SAVEGAME);
	R_RegisterShaderNoMip(ART_SAVEGAME2);
	R_RegisterShaderNoMip(ART_OPTIONS);
	R_RegisterShaderNoMip(ART_OPTIONS2);
	R_RegisterShaderNoMip(ART_RESUMEGAME);
	R_RegisterShaderNoMip(ART_RESUMEGAME2);
	R_RegisterShaderNoMip(ART_LEAVEGAME);
	R_RegisterShaderNoMip(ART_LEAVEGAME2);
	R_RegisterShaderNoMip(ART_EXITGAME);
	R_RegisterShaderNoMip(ART_EXITGAME2);
}
