...
typedef struct clMedia_s {
	...
	struct model_s		*grappleCableModel;
	struct model_s		*powerScreenModel;

	struct model_s		*lightningModel;
	struct model_s		*heatBeamModel;
	struct model_s		*monsterHeatBeamModel;
	...
	// Skins
	struct image_t	    *maleDisguiseSkin;
	struct image_t	    *femaleDisguiseSkin;
	struct image_t	    *cyborgDisguiseSkin;

	struct image_t	    *modelShellGod;
	struct image_t	    *modelShellHalfDam;
	struct image_t	    *modelShellDouble;
	struct image_t	    *modelShellRed;
	struct image_t	    *modelShellGreen;
	struct image_t	    *modelShellBlue;

	// Images
	struct image_t	    *crosshairMat;

	struct image_t	    *tileBackMat;

	struct image_t	    *hudFieldMat;
	struct image_t	    *hudInventoryMat;
	struct image_t	    *hudNetMat;
	struct image_t	    *hudNumMats[2][11];
	struct image_t	    *hudPausedMat;
} clMedia_t;
