...
{	
	...
	*/
	...
	if ( toupper( gl_monolightmap->string[1] ) != 'F' )
	{
		if ( gl_config.renderer == GL_RENDERER_PERMEDIA2 )
		{
			...
			VID_Printf( PRINT_ALL, "...using gl_monolightmap 'a'\n" );
		}
	...
	*/
	...
	if ( strstr( gl_config.extensions_string, "3DFX_set_global_palette" ))
	{
		...
		{
			VID_Printf( PRINT_ALL, "...using 3DFX_set_global_palette\n" );
			qgl3DfxSetPaletteEXT = ( void ( APIENTRY * ) (GLuint *) )qwglGetProcAddress( "gl3DfxSetPaletteEXT" );
			qglColorTableEXT = Fake_glColorTableEXT;
		}
		else
		{
			VID_Printf( PRINT_ALL, "...ignoring 3DFX_set_global_palette\n" );
		}
	}
	else
	{
		VID_Printf( PRINT_ALL, "...3DFX_set_global_palette not found\n" );
	}
#endif
