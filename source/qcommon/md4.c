...
static void MD4Update (MD4_CTX *, unsigned char *, unsigned int);
...
static void MD4Encode (unsigned char *, UINT4 *, unsigned int);
static void MD4Decode (UINT4 *, unsigned char *, unsigned int);
...
/*
 ...
 Continues an MD4 message-digest operation, processing another message
...
/*
 ...
 MD4 finalization.
 Ends an MD4 message-digest operation, writing the message digest and
 zeroizng the context.
 =================
*/
...
/*
 ...
 =================
*/
static void MD4Encode (unsigned char *output, UINT4 *input, unsigned int len){
...
/*
 ...
 =================
*/
static void MD4Decode (UINT4 *output, unsigned char *input, unsigned int len){
