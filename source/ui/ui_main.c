...
#define ART_BACKGROUND			"ui/title_screen/title_backg"
#define ART_LOGO				"ui/title_screen/q2e_logo"
#define ART_SINGLEPLAYER		"ui/title_screen/singleplayer_n"
#define ART_SINGLEPLAYER2		"ui/title_screen/singleplayer_s"
#define ART_MULTIPLAYER			"ui/title_screen/multiplayer_n"
#define ART_MULTIPLAYER2		"ui/title_screen/multiplayer_s"
#define ART_OPTIONS				"ui/title_screen/options_n"
#define ART_OPTIONS2			"ui/title_screen/options_s"
#define ART_CINEMATICS			"ui/title_screen/cinematics_n"
#define ART_CINEMATICS2			"ui/title_screen/cinematics_s"
#define ART_DEMOS				"ui/title_screen/demos_n"
#define ART_DEMOS2				"ui/title_screen/demos_s"
#define ART_MODS				"ui/title_screen/mods_n"
#define ART_MODS2				"ui/title_screen/mods_s"
#define ART_QUIT				"ui/title_screen/quit_n"
#define ART_QUIT2				"ui/title_screen/quit_s"
#define ART_IDLOGO				"ui/title_screen/logo_id"
#define ART_IDLOGO2				"ui/title_screen/logo_id_s"
#define ART_BLURLOGO			"ui/title_screen/logo_blur"
#define ART_BLURLOGO2			"ui/title_screen/logo_blur_s"
#define ART_COPYRIGHT			"ui/title_screen/copyrights"
...
void UI_Main_Precache (void){
	...
	R_RegisterShaderNoMip(ART_LOGO);
	R_RegisterShaderNoMip(ART_SINGLEPLAYER);
	R_RegisterShaderNoMip(ART_SINGLEPLAYER2);
	R_RegisterShaderNoMip(ART_MULTIPLAYER);
	R_RegisterShaderNoMip(ART_MULTIPLAYER2);
	R_RegisterShaderNoMip(ART_OPTIONS);
	R_RegisterShaderNoMip(ART_OPTIONS2);
	R_RegisterShaderNoMip(ART_CINEMATICS);
	R_RegisterShaderNoMip(ART_CINEMATICS2);
	R_RegisterShaderNoMip(ART_DEMOS);
	R_RegisterShaderNoMip(ART_DEMOS2);
	R_RegisterShaderNoMip(ART_MODS);
	R_RegisterShaderNoMip(ART_MODS2);
	R_RegisterShaderNoMip(ART_QUIT);
	R_RegisterShaderNoMip(ART_QUIT2);
	R_RegisterShaderNoMip(ART_IDLOGO);
	R_RegisterShaderNoMip(ART_IDLOGO2);
	R_RegisterShaderNoMip(ART_BLURLOGO);
	R_RegisterShaderNoMip(ART_BLURLOGO2);
	R_RegisterShaderNoMip(ART_COPYRIGHT);
}
...
#define ART_BANNER				"ui/banners/aybabtu_t"
#define ART_MOO					"ui/misc/moo"
...
static void UI_AllYourBase_Init (void){
	...
	memset(&uiAllYourBase, 0, sizeof(uiAllYourBase_t));
