...
static void UI_Advanced_SetConfig (void){
	...
	Cvar_SetInteger("r_arb_multitexture", (int)uiAdvanced.multitexture.curValue);

	Cvar_SetInteger("r_arb_vertex_buffer_object", (int)uiAdvanced.vbo.curValue);

	Cvar_SetInteger("r_arb_texture_env_combine", (int)uiAdvanced.texEnvCombine.curValue);

	Cvar_SetInteger("r_arb_texture_env_add", (int)uiAdvanced.texEnvAdd.curValue);

	Cvar_SetInteger("r_arb_texture_env_dot3", (int)uiAdvanced.texEnvDOT3.curValue);

	Cvar_SetInteger("r_arb_vertex_program", (int)uiAdvanced.vertexProgram.curValue);

	Cvar_SetInteger("r_arb_fragment_program", (int)uiAdvanced.fragmentProgram.curValue);

	Cvar_SetInteger("r_arb_texture_cube_map", (int)uiAdvanced.cubeMapTexture.curValue);

	Cvar_SetInteger("r_ext_texture_rectangle", (int)uiAdvanced.rectangleTexture.curValue);

	Cvar_SetInteger("r_arb_texture_compression", (int)uiAdvanced.textureCompress.curValue);

	Cvar_SetInteger("r_ext_texture_filter_anisotropic", (int)uiAdvanced.anisotropic.curValue);
...
static void UI_Advanced_UpdateConfig (void){
	...
	if (!uiStatic.glConfig.textureFilterAnisotropic)
		uiAdvanced.maxAnisotropy.curValue = 2.0;
	Q_snprintfz(anisotropyText, sizeof(anisotropyText), "%.2f", uiAdvanced.maxAnisotropy.curValue);
