...
#define ART_BANNER				"ui/banners/options_t"
#define ART_PLAYERSETUP			"ui/misc/players"
#define ART_PLAYERSETUP2		"ui/misc/players_s"
#define ART_CONTROLS			"ui/misc/controls"
#define ART_CONTROLS2			"ui/misc/controls_s"
#define ART_GAMEOPTIONS			"ui/misc/goptions"
#define ART_GAMEOPTIONS2		"ui/misc/goptions_s"
#define ART_AUDIO				"ui/misc/audio"
#define ART_AUDIO2				"ui/misc/audio_s"
#define ART_VIDEO				"ui/misc/video"
#define ART_VIDEO2				"ui/misc/video_s"
#define ART_PERFORMANCE			"ui/misc/performance"
#define ART_PERFORMANCE2		"ui/misc/performance_s"
#define ART_NETWORK				"ui/misc/network"
#define ART_NETWORK2			"ui/misc/network_s"
#define ART_DEFAULTS			"ui/misc/defaults"
#define ART_DEFAULTS2			"ui/misc/defaults_s"
...
void UI_Options_Precache (void){
	...
	R_RegisterShaderNoMip(ART_PLAYERSETUP);
	R_RegisterShaderNoMip(ART_PLAYERSETUP2);
	R_RegisterShaderNoMip(ART_CONTROLS);
	R_RegisterShaderNoMip(ART_CONTROLS2);
	R_RegisterShaderNoMip(ART_GAMEOPTIONS);
	R_RegisterShaderNoMip(ART_GAMEOPTIONS2);
	R_RegisterShaderNoMip(ART_AUDIO);
	R_RegisterShaderNoMip(ART_AUDIO2);
	R_RegisterShaderNoMip(ART_VIDEO);
	R_RegisterShaderNoMip(ART_VIDEO2);
	R_RegisterShaderNoMip(ART_PERFORMANCE);
	R_RegisterShaderNoMip(ART_PERFORMANCE2);
	R_RegisterShaderNoMip(ART_NETWORK);
	R_RegisterShaderNoMip(ART_NETWORK2);
	R_RegisterShaderNoMip(ART_DEFAULTS);
	R_RegisterShaderNoMip(ART_DEFAULTS2);
}
